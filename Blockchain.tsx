    ...
    <div className="space-y-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50 flex items-center">
                <Box size={24} className="mr-3 text-primary-500" /> Deeper Life Chain (DLC)
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-lg border-l-4 border-primary-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                            {blockchainTransactions.map((tx, i) => (
                                <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    <td className="px-5 py-4 whitespace-nowrap text-sm font-mono text-primary-600 dark:text-primary-400 truncate max-w-xs">{tx.txHash}</td>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
                ...
                <div className="space-y-4">
                    ...
                    <button className="w-full bg-gradient-to-r from-primary-600 to-primary-800 text-white font-bold py-3 rounded-lg hover:opacity-90 transition-opacity">
