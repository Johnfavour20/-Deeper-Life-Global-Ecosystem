...
const Events: React.FC = () => (
    <div className="space-y-6">
        ...
        <div className="bg-gradient-to-br from-primary-600 via-primary-800 to-primary-950 rounded-2xl p-8 text-white shadow-2xl">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 text-primary-200 mb-4">
                    ...
                    <p className="text-primary-100 mb-6">Join millions of believers worldwide for a life-transforming encounter with God through the ministry of Pastor W.F. Kumuyi. Streaming live to all nations.</p>
                    <div className="flex items-center space-x-4">
                        <button className="bg-white text-primary-600 font-bold px-8 py-3 rounded-lg hover:bg-gray-100 transition-transform hover:scale-105">Join Live Stream</button>
        ...
        <div className="flex flex-wrap gap-2">
            {['All', 'Global', 'Local', 'Youth', 'Ministry'].map(type => (
                <button key={type} className="bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-4 py-2 rounded-full text-sm font-medium hover:bg-primary-100 dark:hover:bg-primary-900/50">{type}</button>
            ))}
        </div>
                    ...
                    <div key={index} className="flex flex-col sm:flex-row items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <div className="flex items-center space-x-4 mb-3 sm:mb-0">
                            <div className="text-center w-20">
                                <p className="text-secondary font-bold text-lg">{new Date(event.date).toLocaleString('default', { month: 'short' }).toUpperCase()}</p>
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <button className="bg-primary-600 text-white text-sm px-4 py-2 rounded-lg hover:bg-primary-700">Register</button>
                        </div>
                    </div>
                ))}
            </div>
