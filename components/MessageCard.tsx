        ...
        <div className="bg-white dark:bg-gray-800/50 rounded-lg p-4 shadow-md border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-all duration-300">
            <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                    ...
                    <p className="text-blue-600 dark:text-blue-400 text-sm font-medium mt-1">{speaker}</p>
                ...
                {isLive && (
                    <div className="flex items-center bg-red-500 text-white text-xs px-2 py-1 rounded-full ml-3">
            ...
            <div className="flex items-center space-x-2">
                <button className="flex items-center bg-blue-600 text-white px-3 py-1.5 rounded-md text-sm hover:bg-blue-700 transition-colors">
